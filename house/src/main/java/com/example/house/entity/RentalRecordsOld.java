 ...
 */
@Entity
@Table(name = "rental_records_old")
public class RentalRecordsOld {
    ...
    // 构造函数
    public RentalRecordsOld() {}
    
    public RentalRecordsOld(String roomNumber, String tenantName, BigDecimal totalRent, LocalDate paymentDate) {
